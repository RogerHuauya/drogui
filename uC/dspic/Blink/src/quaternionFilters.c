...
#define Ki 0.0f
/*
const double GyroMeasError = PI * (40.0f / 180.0f);
const double GyroMeasDrift = PI * (0.0f  / 180.0f);

double beta =  0.866025f * PI * (40.0f / 180.0f);   // Compute beta
double zeta = 0;

double eInt[3] = {0.0f, 0.0f, 0.0f};
...
void MahonyQuaternionUpdate(double ax, double ay, double az, double gx, double gy, double gz, double mx, double my, double mz, double deltat)
{
  // short name local variable for readability
  double q1 = q[0], q2 = q[1], q3 = q[2], q4 = q[3];
  double norm;

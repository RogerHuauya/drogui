...
#define PIN_INT PRTA, 14
#define PIN_RST PRTD, 3
void IntPinHandler();
...
typedef struct _sensor{
        ...
        double dDataX, dDataY, dDataZ, dDataW;          // Data field variables
        UINT16 wRMWdata;
        double dMult;
} sensor;
...
void error_handler(char *s, UINT16, UINT16);

...
UINT8 initMM7150(){
    ...
    for (ucSensor_num = 0; ucSensor_num <= NUM_SENS; ucSensor_num++) //go through the sensor list but only GetFeatureReport for valid ids   
    {
        ...
        {
            hid_i2c_cmd_process(ucBuf, HID_GET_RPT_FEAT, SENSOR[ucSensor_num].id);  // Get feature report for all valid sensors and update _VREG register

        }
    }


    _VREG.stat.stat4.SHStartStatus = VREG_SHSTART_SUCCESS;          // HID startup successful, update status register (VREG 0x3F) 

    _VREG.SHC.SHwake = TRUE;                                        // HID device is now awake and ready for operation
    _VREG.SHC.SHstart = TRUE;
...
* @note        Parse input report, update data _VREG 
...
void parse_update_VREG_data (UINT8 ucSensorNum, UINT8 *ucInpRep)
{
    ...
    {     
        case ACCEL_VREG_OFFSET:                                     // Accelerometer data has been read
            ...
            _VREG._data.ACXD = ((ucInpRep[SENSOR[ACCEL_VREG_OFFSET].DatOffset + 1] << BYTE_SHIFT) | ucInpRep[SENSOR[ACCEL_VREG_OFFSET].DatOffset]);    // parse data from data offset found in report descriptor
            _VREG._data.ACYD = ((ucInpRep[SENSOR[ACCEL_VREG_OFFSET].DatOffset + 3] << BYTE_SHIFT) | ucInpRep[SENSOR[ACCEL_VREG_OFFSET].DatOffset + 2]);
            _VREG._data.ACZD = ((ucInpRep[SENSOR[ACCEL_VREG_OFFSET].DatOffset + 5] << BYTE_SHIFT) | ucInpRep[SENSOR[ACCEL_VREG_OFFSET].DatOffset + 4]);
            break;

        case GYRO_VREG_OFFSET:                                      // Gyrometer data has been read
 
            _VREG._data.GYXD = ((ucInpRep[SENSOR[GYRO_VREG_OFFSET].DatOffset + 1] << BYTE_SHIFT) | ucInpRep[SENSOR[GYRO_VREG_OFFSET].DatOffset]);
            _VREG._data.GYYD = ((ucInpRep[SENSOR[GYRO_VREG_OFFSET].DatOffset + 3] << BYTE_SHIFT) | ucInpRep[SENSOR[GYRO_VREG_OFFSET].DatOffset + 2]);
            _VREG._data.GYZD = ((ucInpRep[SENSOR[GYRO_VREG_OFFSET].DatOffset + 5] << BYTE_SHIFT) | ucInpRep[SENSOR[GYRO_VREG_OFFSET].DatOffset + 4]);
            break;

        case CMP_VREG_OFFSET:                                       // Compass data has been read
  
            _VREG._data.CMD = ((ucInpRep[SENSOR[CMP_VREG_OFFSET].DatOffset + 1] << BYTE_SHIFT) | ucInpRep[SENSOR[CMP_VREG_OFFSET].DatOffset]);
            break;
        
        case ORI_VREG_OFFSET:                                       // Orientation data has been read

            _VREG._data.ORXD = ((ucInpRep[SENSOR[ORI_VREG_OFFSET].DatOffset + 1] << BYTE_SHIFT) | ucInpRep[SENSOR[ORI_VREG_OFFSET].DatOffset]);
            _VREG._data.ORYD = ((ucInpRep[SENSOR[ORI_VREG_OFFSET].DatOffset + 3] << BYTE_SHIFT) | ucInpRep[SENSOR[ORI_VREG_OFFSET].DatOffset + 2]);
            _VREG._data.ORZD = ((ucInpRep[SENSOR[ORI_VREG_OFFSET].DatOffset + 5] << BYTE_SHIFT) | ucInpRep[SENSOR[ORI_VREG_OFFSET].DatOffset + 4]);
            _VREG._data.ORWD = ((ucInpRep[SENSOR[ORI_VREG_OFFSET].DatOffset + 7] << BYTE_SHIFT) | ucInpRep[SENSOR[ORI_VREG_OFFSET].DatOffset + 6]);
            break;
       
        case INCL_VREG_OFFSET:                                      // Inclinometer data has been read

            _VREG._data.INXD = ((ucInpRep[SENSOR[INCL_VREG_OFFSET].DatOffset + 1] << BYTE_SHIFT) | ucInpRep[SENSOR[INCL_VREG_OFFSET].DatOffset]);
            _VREG._data.INYD = ((ucInpRep[SENSOR[INCL_VREG_OFFSET].DatOffset + 3] << BYTE_SHIFT) | ucInpRep[SENSOR[INCL_VREG_OFFSET].DatOffset + 2]);
            _VREG._data.INZD = ((ucInpRep[SENSOR[INCL_VREG_OFFSET].DatOffset + 5] << BYTE_SHIFT) | ucInpRep[SENSOR[INCL_VREG_OFFSET].DatOffset + 4]);
            break;

        case RAW_ACC_VREG_OFFSET:                                   // Raw data has been read
            
            _VREG._data.RACXD = ((ucInpRep[SENSOR[RAW_VREG_OFFSET].DatOffset + 1] << BYTE_SHIFT) | ucInpRep[SENSOR[RAW_VREG_OFFSET].DatOffset]);
            _VREG._data.RACYD = ((ucInpRep[SENSOR[RAW_VREG_OFFSET].DatOffset + 3] << BYTE_SHIFT) | ucInpRep[SENSOR[RAW_VREG_OFFSET].DatOffset + 2]);
            _VREG._data.RACZD = ((ucInpRep[SENSOR[RAW_VREG_OFFSET].DatOffset + 5] << BYTE_SHIFT) | ucInpRep[SENSOR[RAW_VREG_OFFSET].DatOffset + 4]);
            break;
       
        case RAW_MAG_VREG_OFFSET:                                   // Raw MAG data has been read
            
            _VREG._data.MGFXD = ((ucInpRep[SENSOR[RAW_MAG_VREG_OFFSET].DatOffset + 1] << BYTE_SHIFT) | ucInpRep[SENSOR[RAW_MAG_VREG_OFFSET].DatOffset]);
            _VREG._data.MGFYD = ((ucInpRep[SENSOR[RAW_MAG_VREG_OFFSET].DatOffset + 3] << BYTE_SHIFT) | ucInpRep[SENSOR[RAW_MAG_VREG_OFFSET].DatOffset + 2]);
            _VREG._data.MGFZD = ((ucInpRep[SENSOR[RAW_MAG_VREG_OFFSET].DatOffset + 5] << BYTE_SHIFT) | ucInpRep[SENSOR[RAW_MAG_VREG_OFFSET].DatOffset + 4]);
            _VREG._data.RMGXD = ((ucInpRep[SENSOR[RAW_MAG_VREG_OFFSET].DatOffset + 7] << BYTE_SHIFT) | ucInpRep[SENSOR[RAW_MAG_VREG_OFFSET].DatOffset + 6]);
            _VREG._data.RMGYD = ((ucInpRep[SENSOR[RAW_MAG_VREG_OFFSET].DatOffset + 9] << BYTE_SHIFT) | ucInpRep[SENSOR[RAW_MAG_VREG_OFFSET].DatOffset + 8]);
            _VREG._data.RMGZD = ((ucInpRep[SENSOR[RAW_MAG_VREG_OFFSET].DatOffset + 11] << BYTE_SHIFT) | ucInpRep[SENSOR[RAW_MAG_VREG_OFFSET].DatOffset + 10]);
            break;
        
        case RAW_GYR_VREG_OFFSET:                                   // Raw GYRO data has been read
            
            _VREG._data.RGYXD = ((ucInpRep[SENSOR[RAW_GYR_VREG_OFFSET].DatOffset + 1] << BYTE_SHIFT) | ucInpRep[SENSOR[RAW_GYR_VREG_OFFSET].DatOffset]);
            _VREG._data.RGYYD = ((ucInpRep[SENSOR[RAW_GYR_VREG_OFFSET].DatOffset + 3] << BYTE_SHIFT) | ucInpRep[SENSOR[RAW_GYR_VREG_OFFSET].DatOffset + 2]);
            _VREG._data.RGYZD = ((ucInpRep[SENSOR[RAW_GYR_VREG_OFFSET].DatOffset + 5] << BYTE_SHIFT) | ucInpRep[SENSOR[RAW_GYR_VREG_OFFSET].DatOffset + 4]);
            break;
...
* @note        Reads & returns contents of requested virtual (VREG) register while updating the SHC VREG to reflect the appropriate sensor. Also checks for input data & parses it into data _VREG. 
...
UINT8 HOST_SF_LIB_VREG_read(UINT8 ucRegOffset, UINT16 *usData)
{
    ...
    usRegPtr = (UINT16 *)&_VREG.SHC;                                // Set the pointer to SHC (VREG00 register)
...
*        while updating the SHC VREG to reflect the appropriate sensor. Also checks for input data & parses it into data _VREG. 
* @param ucRegOffset VREG register of interest
...
UINT8 HOST_SF_LIB_VREG_write(UINT8 ucRegOffset, UINT16 usData)
{
    ...
    usSHC_ptr = (UINT16 *)&_VREG.SHC;                               // Set pointers to SHC (VREG00 register)
    ...
    if (_VREG.SHC.SHstart)                                          // this bit set during VREG_init and after RESET (no user access to this bit)
    { 
        ...
        {
            usStat_ptr = (UINT16 *)&_VREG.stat;                     // Set the status register pointer to the first status register
       ...
       /*****************RESET COMMAND********************/
            if (usData & VREG_SHC_RST_BIT)                          // Reset bit has been set
            {
                ...
                {
                    memset(&_VREG, 0x00, sizeof(_VREG));            // Initialize VREG registers to POR values
                    _VREG.stat.stat4.ResetStatus = VREG_RST_CMD_SUCCESS; // Status update to notify command set succesful
                    _VREG.SHC.SHstart = TRUE;
                    _VREG.SHC.SHwake = TRUE;
                    return SUCCESS;                                 //return success (all VREG bits have been reset to POR values)
                }
                else
                {
                    _VREG.stat.stat4.ResetStatus = VREG_RESET_CMD_FAIL; // Status update to notify command set error occurred
                    return RESET_FAIL;
                }
            }
       ...
       /*****************WAKE COMMAND********************/
            if (usData & VREG_SHC_WAKE_BIT)                         // wake bit set?
            {
                if ((usPREV_SHC_STATE & VREG_SHC_WAKE_BIT) == 0)    // this bit was not previously set, issue wake command
                {
                    ...
                    __delay_ms(12);                                      //wait 12 ms (11 ms min per spec) after wake signal and before sending POWER_ON command to SSC7150
                                        
                    if (!hid_i2c_cmd_process(0, POWER_ON, ARB_ID))  // Issue the wake command (parameters 1 and 3 are not used)
                    {
                        _VREG.SHC.sleep = FALSE;                    //clear the sleep bit as per API spec
                        _VREG.SHC.SHwake = TRUE;
                        _VREG.stat.stat4.ShSleepWakeStatus = VREG_WAKE_SUCCESS; // Status update to notify command set succesful
                                                
                        //spec says must wait a minimum of 30 ms before next command to SSC7150, so let's wait here...
                        __delay_ms(31);                                  //dDlay_ms 31 ms (30 ms min per spec)
                    }
                    else
                    {
                        _VREG.stat.stat4.ShSleepWakeStatus = VREG_WAKE_FAIL; // Status update to notify command set error occurred
            ...
            if (usData & VREG_SHC_SLP_BIT)                          //sleep bit set?
            {
                ...
                if ((usPREV_SHC_STATE & VREG_SHC_SLP_BIT) == 0)     // this bit was not previously set, issue sleep command
                {
                    ...
                    {
                        _VREG.stat.stat4.ShSleepWakeStatus = VREG_SLEEP_SUCCESS; // Status update to notify command set succesful
                        _VREG.SHC.sleep = TRUE;                     // Set SHC (VREG00) to show SSC7150 device is asleep   
                        _VREG.SHC.SHwake = FALSE;                   // Clear SHC (VREG00) bit that shows device is not awake
                        
                        //spec says must wait a minimum of 70 ms before wake command, so let's wait here...
                        __delay_ms(71);                                  //dDlay_ms 71 ms (70 ms min per spec)
                   ...
                   {
                        _VREG.stat.stat4.ShSleepWakeStatus = VREG_SLEEP_FAIL;  // Status update to notify command set error occurred
    ...
    /*****************SENSITIVITY-CHANGE COMMAND********************/
        ...
        {
            usStat_ptr = (UINT16 *)&_VREG.stat;                     // Reset the status register pointer to the first status register (VREG3C)
    ...
    /*****************STATUS-BIT-CLEAR COMMAND********************/
        ...
        {
            usStat_ptr = (UINT16 *)&_VREG.stat;                     // Reset the status register pointer to the first status register
...
void error_handler(char *str, UINT16 offset, UINT16 errval) {
  ...
  serialWriteString(&Serial1, err_buf);
}
...
UINT8 i2c_cmd_WrRd(UINT8 ucCmd, UINT8 ucBytes_wr, UINT8 *ucData_wr, UINT16 usBytes_rd, UINT8 *ucData_rd, BOOL bAdjust)
{
	UINT8 i;
  	...
  	i2cStop(&imu);                                                     //turn off timer2 interrupt
...
UINT8 RAW_SENSOR_CNT = 0;                                           //for backward compatibility to F/W with all-in-one RAW sensor data
                                         //structure containing the VREG registers 
...
UINT16 hid_i2c_descriptor_handler(UINT8 ucCmd_req)
{
    ...
    {  
        case GET_HID_DESC:                                          //read the HID Config Descriptor from SSC7150
            ...
            _VREG.IDs.PID = HID_FIELD.wProdID;                      // Update virtual register fields
            _VREG.IDs.VID = HID_FIELD.wVenID;
            _VREG.IDs.DID = HID_FIELD.wVerID;
...
UINT8 hid_i2c_cmd_process(UINT8 *ucCmdDatbuf, UINT8 ucCmd_req, UINT8 ucReport_id)
{
    ...
    UINT16 *usVREGSptr = (UINT16 *)&_VREG;                          // Pointer to individual virtual registers; initialized to start of _VREG struct
    ...
    switch(ucCmd_req)
    {
        ...
        case RESET_DEV_CMD:                                         //HID Reset command                      
            ...
            _VREG.SHC.reset = VREG_RESET_SUCCESS;                   // Clear the reset VREG to indicate successful 
        ...
        case HID_GET_RPT_FEAT:
            ...
            {   
                ...
                {        
                    usVREGSptr = &_VREG.sensitivity.ACSEN + ucSensPtr; // Set pointer to appropriate sensitivity register (as offset from accelerometer sensitivity VREG02)
                    ...
                    *usVREGSptr = ( (ucCmdDatbuf[SENSOR[ucSensPtr].SensOffset + GF_SENS_OFFSET_MSB] << BYTE_SHIFT) | ucCmdDatbuf[SENSOR[ucSensPtr].SensOffset + GF_SENS_OFFSET_LSB]); // Use info about offsets to set _VREG to appropriate data
                    
                    usVREGSptr = &_VREG.data_rt.ACDXR + ucSensPtr;  // Set pointer to appropriate data rate register
                    ...
                    *usVREGSptr = ((ucCmdDatbuf[SENSOR[ucSensPtr].DatRtOffset + GF_DATR_OFFSET_MSB] << BYTE_SHIFT) | ucCmdDatbuf[SENSOR[ucSensPtr].DatRtOffset + GF_DATR_OFFSET_LSB]); //point to appropriate data fields within the feature report and store in VREG reg
                    ...
                    usVREGSptr = (UINT16 *)&(_VREG.expo.exp1);      //point to appropriate data fields within the feature report and store in VREG reg  NOTE: each exponent VREG holds 4 devices' 4bit exponent value fields
...
UINT8 report_parse(UINT8 *ucBuf)
{
    ...
    memset(&SENSOR, 0xFF, sizeof(SENSOR));                          // Init & Rearrange structs into order compatible with _VREG structure            
    ...
    for (ucSensptr = 0; ucSensptr < NUM_SENS; ucSensptr++)          // go through the entire sensor list looking for sensor types
    {
        if (TEMP_SF[ucSensptr].type == ACCEL_SENSOR_TYPE)           // Sensor type identifier for accelerometer
        {
            ...
            _VREG.SL.accel = TRUE;                                  // VREG01 accelerometer available bit(0) set
        }
        ...
        if (TEMP_SF[ucSensptr].type == GYRO_SENSOR_TYPE)            // Sensor type identifier for gyrometer
        {
            ...
            _VREG.SL.gyro = TRUE;                                   // VREG01 gyrometer available bit(1) set
        }
        ...
        if (TEMP_SF[ucSensptr].type == CMP_SENSOR_TYPE)             // Sensor type identifier for compass
        {
            ...
            _VREG.SL.cmp = TRUE;                                    // VREG01 compass available bit(2) set
        }
        ...
        if (TEMP_SF[ucSensptr].type == ORI_SENSOR_TYPE)             // Sensor type identifier for orientation sensor
        {
            ...
            _VREG.SL.ori = TRUE;                                    // VREG01 orientation available bit(3) set
        }
        ...
        if (TEMP_SF[ucSensptr].type == INCL_SENSOR_TYPE)            // Sensor type identifier for inclinometer
        {
            ...
            _VREG.SL.incl = TRUE;                                   // VREG01 gyrometer available bit(4) set
        }
...
UINT8 HOST_SF_LIB_HID_Get_Report(UINT8 type, UINT8* ReportBuffer, UINT8 size)
{
    ...
    serialWriteString(&Serial1, "--------------------------------------------------------\n");
    serialWriteString(&Serial1, "GRP report\n");
    for (int i = 0 ; i < 30 ; i++)
      serialWriteChar(&Serial1, ReportBuffer[i]);
    serialWriteString(&Serial1, "--------------------------------------------------------\n");
    
    if (ucRetStat != SUCCESS)
    {   serialWriteString(&Serial1, "ERROR\n");
...
void initAccel(sensor *s,int rate, int sensitivity) {
  // Enable the Accelerometer
  // To support multi-threaded applications, Read-Modify-Write the VREG:
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
  {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) | VREG_SHC_ACC_EN))) // Enable the accelerometer (ACC_EN)
      error_handler("VRWr", VREG_SHC, (s->ucRetStat));  // error display
  }
  else
    error_handler("VRRd", VREG_SHC, (s->ucRetStat));       // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_ACSEN, sensitivity)))   // Change Accelerometer sensitivity
    error_handler("VRWr", VREG_ACSEN, (s->ucRetStat));     // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_ACDXR, rate))) // Change acc data rate
    error_handler("VRWr", VREG_ACDXR, (s->ucRetStat));     // error display
  (s -> dMult) = ret_exponent(ACCEL_VREG_OFFSET);            // Get unit exponent for this sensor's data
}

void readAccel(sensor *s){

  // get acc readings
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_ACXD, &(s -> wdata))))  // Read data from the accelerometer datax register
    error_handler("VRRd", VREG_ACXD, (s->ucRetStat));  // error display

  (s -> dDataX) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_ACYD, &(s -> wdata))))  // Read data from the accelerometer datay register
    error_handler("VRRd", VREG_ACYD, (s->ucRetStat));  // error display

  (s -> dDataY) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_ACZD, &(s -> wdata))))  // Read data from the accelerometer dataz register
    error_handler("VRRd", VREG_ACZD, (s->ucRetStat));  // error display

  (s -> dDataZ) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value


  //sprintf(_glob, "Acc:: X: %4.3f Y: %4.3f Z: %4.3f",(s -> dDataX), (s -> dDataY), (s -> dDataZ));
  //Serial.println(_glob);

}

void finishAccel(sensor *s){

      //Disable the Accelerometer on exit
      if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
      {
        if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) & ~VREG_SHC_ACC_EN))) // Disable the accelerometer (clear the ACC_EN bit)
          error_handler("VRWr", VREG_SHC, (s->ucRetStat)); // error display
      }
      else
        error_handler("VRRd", VREG_SHC, (s->ucRetStat));   // error display
...
void initOrient(sensor *s,int rate, int sensitivity) {
  // Enable the Orientation sensor
  // To support multi-threaded applications, Read-Modify-Write the VREG:
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
  {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) | VREG_SHC_ORI_EN))) // Enable the orientation (ORI_EN)
      error_handler("VRWr", VREG_SHC, (s->ucRetStat));  // error display
  }
  else
    error_handler("VRRd", VREG_SHC, (s->ucRetStat));       // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_ORSEN, sensitivity)))    // Change ORI sensitivity
    error_handler("VRWr", VREG_ORSEN, (s->ucRetStat));     // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_ORDR, rate)))     // Change ORI data rate
    error_handler("VRWr", VREG_ORDR, (s->ucRetStat));      // error display
  (s -> dMult) = ret_exponent(ORI_VREG_OFFSET);              // Get unit exponent for this sensor's data
}
void readOrient(sensor *s) {

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_ORXD, &(s -> wdata)))) // Read data from the orientation sensor datax register
    error_handler("VRRd", VREG_ORXD, (s->ucRetStat));  // error display

  (s -> dDataX) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_ORYD, &(s -> wdata)))) // Read data from the orientation sensor datay register
    error_handler("VRRd", VREG_ORYD, (s->ucRetStat));  // error display

  (s -> dDataY) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_ORZD, &(s -> wdata)))) // Read data from the orientation sensor dataz register
    error_handler("VRRd", VREG_ORZD, (s->ucRetStat));  // error display

  (s -> dDataZ) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_ORWD, &(s -> wdata))))  // Read data from the orientation sensor dataw register
    error_handler("VRRd", VREG_ORWD, (s->ucRetStat));  //error display

  (s -> dDataW) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

  //sprintf(_glob, "Ori:: X: %4.3f Y: %4.3f Z: %4.3f W: %4.3f",(s -> dDataX), (s -> dDataY), (s -> dDataZ), (s -> dDataW));
  //Serial.println(_glob);
    
}
void finishOrient(sensor *s) {
      //Disable the orientation sensor on exit
      if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
      {
        if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) & ~VREG_SHC_ORI_EN))) // Disable the orientation sensor (clear the ORI_EN bit)
          error_handler("VRWr", VREG_SHC, (s->ucRetStat));      // error display
      }
      else
        error_handler("VRRd", VREG_SHC, (s->ucRetStat)); // error display
...
void initInclin(sensor *s,int rate, int sensitivity) {
  // Enable the Inclinometer
  // To support multi-threaded applications, Read-Modify-Write the VREG:
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
  {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) | VREG_SHC_INC_EN))) // Enable the Inclinometer (INC_EN)
      error_handler("VRWr", VREG_SHC, (s->ucRetStat));  // error display
  }
  else
    error_handler("VRRd", VREG_SHC, (s->ucRetStat));       // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_INSEN, sensitivity)))    // Change sensitivity
    error_handler("VRWr", VREG_INSEN, (s->ucRetStat));     // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_INDR, rate)))    // Change data rate
    error_handler("VRWr", VREG_INDR, (s->ucRetStat));      // error display
  (s -> dMult) = ret_exponent(INCL_VREG_OFFSET);             // Get unit exponent for this sensor's data

}
void readInclin(sensor *s) {

    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_INXD, &(s -> wdata)))) // Read data from the inclinometer datax register
      error_handler("VRRd", VREG_INXD, (s->ucRetStat));  // error display

    (s -> dDataX) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_INYD, &(s -> wdata))))  // Read data from the inclinometer datay register
      error_handler("VRRd", VREG_INYD, (s->ucRetStat));  // error display

    (s -> dDataY) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_INZD, &(s -> wdata))))  // Read data from the inclinometer dataz register
      error_handler("VRRd", VREG_INZD, (s->ucRetStat));  // error display

    (s -> dDataZ) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value
}
void finishInclin(sensor *s) {

      // Disable the Inclinometer on exit
      if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
      {
        if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) & ~VREG_SHC_INC_EN))) // Disable the Inclinometer (clear the INC_EN bit)
          error_handler("VRWr", VREG_SHC, (s->ucRetStat));      // error display
      }
      else
        error_handler("VRRd", VREG_SHC, (s->ucRetStat)); // error display
...
void initCompass(sensor *s,int rate, int sensitivity) {
  // Enable the Compass
  // To support multi-threaded applications, Read-Modify-Write the VREG :
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
  {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) | VREG_SHC_CMP_EN))) // Enable the compass (CMP_EN)
      error_handler("VRWr", VREG_SHC, (s->ucRetStat));  // error display
  }
  else
    error_handler("VRRd", VREG_SHC, (s->ucRetStat));       // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_CMSEN, sensitivity)))   // Change CMP sensitivity
    error_handler("VRWr", VREG_CMSEN, (s->ucRetStat));     // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_CMDR, rate)))    // Change CMP data rate
    error_handler("VRWr", VREG_CMDR, (s->ucRetStat));      // error display
  (s -> dMult) = ret_exponent(CMP_VREG_OFFSET);              // Get unit exponent for this sensor's data
}

void readCompass(sensor *s) {

    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_CMD, &(s -> wdata)))) // Read data from the compass data register
      error_handler("VRRd", VREG_CMD, (s->ucRetStat));   // error display

    (s -> dDataX) = (int16_t)(s -> wdata) * (s -> dMult);                    // Note: for the compass there is only one data field to be retrieved

}

void finishCompass(sensor *s) {

      //Disable the Compass on exit
      if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
      {
        if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) & ~VREG_SHC_CMP_EN))) // Disable the compass (clear the CMP_EN bit)
          error_handler("VRWr", VREG_SHC, (s->ucRetStat));      // error display
      }
      else
        error_handler("VRRd", VREG_SHC, (s->ucRetStat)); // error display
...
void initGyro(sensor *s,int rate, int sensitivity) {
  // Enable the Gyrometer
  // To support multi-threaded applications, Read-Modify-Write the VREG:
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
  {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) | VREG_SHC_GYRO_EN))) // Enable the Gyrometer (GYRO_EN)
      error_handler("VRWr", VREG_SHC, (s->ucRetStat));  // error display
  }
  else
    error_handler("VRRd", VREG_SHC, (s->ucRetStat));       // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_GYSEN, sensitivity)))  // Change gyro sensitivity
    error_handler("VRWr", VREG_GYSEN, (s->ucRetStat));     // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_GYDR, rate)))    // Change gyro data rate
    error_handler("VRWr", VREG_GYDR, (s->ucRetStat));      // error display

  (s -> dMult) = ret_exponent(GYRO_VREG_OFFSET);             // Get unit exponent for this sensor's data
}

void readGyro(sensor *s) {
    // get gyro readings
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_GYXD, &(s -> wdata))))  // Read data from the gyrometer datax register
      error_handler("VRRd", VREG_GYXD, (s->ucRetStat));  // error display

    (s -> dDataX) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_GYYD, &(s -> wdata))))  // Read data from the gyrometer datay register
      error_handler("VRRd", VREG_GYYD, (s->ucRetStat));  // error display

    (s -> dDataY) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_GYZD, &(s -> wdata))))  // Read data from the gyrometer dataz register
      error_handler("VRRd", VREG_GYZD, (s->ucRetStat));  // error display

    (s -> dDataZ) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value
}

void finishGyro(sensor *s) {
  //Disable the Gyrometer on exit
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
  {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) & ~VREG_SHC_GYRO_EN))) // Disable the Gyrometer (clear the GYRO_EN bit)
      error_handler("VRWr", VREG_SHC, (s->ucRetStat)); // error display
  }
  else
    error_handler("VRRd", VREG_SHC, (s->ucRetStat)); // error display
...
void initRawAccel(sensor *s) {
  // Enable the Raw Accelerometer
  // To support multi-threaded applications, Read-Modify-Write the VREG:
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
  {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) | VREG_SHC_RAWACC_EN | VREG_SHC_ACC_EN))) // Enable the raw accelerometer (RAWACC_EN)& corresponding ACCEL sensor
  ...
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_RACSEN, RAW_SENSITIVITY_MIN))) // Set Raw Acc (and corresponding sensor (Acc)) sensitivity to "0" to
                                        //achieve the desired data rate for raw sensors (see spec).
    error_handler("VRWr", VREG_RACSEN, (s->ucRetStat));    // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_ACSEN, RAW_SENSITIVITY_MIN))) // Set Acc sensitivity to "0" to achieve the desired data rates for raw sensors.
    error_handler("VRWr", VREG_ACSEN, (s->ucRetStat));    // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_RACDR, RAW_DATA_RATE))) // Change Raw Acc data rate
    error_handler("VRWr", VREG_RACDR, (s->ucRetStat));     //error display

  (s -> dMult) = ret_exponent(RAW_ACC_VREG_OFFSET);          // Get unit exponent for this sensor's data
}

void readRawAccel(sensor *s) {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_RACXD, &(s -> wdata))))  // Read data from the raw accelerometer datax register
      error_handler("VRRd", VREG_RACXD, (s->ucRetStat)); // error display

    (s -> dDataX) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_RACYD, &(s -> wdata)))) // Read data from the raw accelerometer datay register
      error_handler("VRRd", VREG_RACYD, (s->ucRetStat)); // error display

    (s -> dDataY) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_RACZD, &(s -> wdata))))  // Read data from the raw accelerometer dataz register
      error_handler("VRRd", VREG_RACZD, (s->ucRetStat)); // error display

    (s -> dDataZ) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value
}

void finishRawAccel(sensor *s) {

  // Disable the Raw Accelerometer & corresponding ACCEL sensor on exit
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
  {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) & ~(VREG_SHC_RAWACC_EN | VREG_SHC_ACC_EN)))) // Disable the raw accelerometer (clear the RAWACC_EN bit) & corresponding ACC_EN
      error_handler("VRWr", VREG_SHC, (s->ucRetStat));      // error display
  }
  else
    error_handler("VRRd", VREG_SHC, (s->ucRetStat)); // error display
...
void initRawMagnet(sensor *s) {
  // Enable the Raw Magnometer
  // To support multi-threaded applications, Read-Modify-Write the VREG :
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
  {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) | VREG_SHC_RAWMAG_EN | VREG_SHC_CMP_EN))) // Enable the  Raw Magnometer (RAWMAG_EN) & corresponding CMP sensor
                                                       //rev 0.10 spec: 'for any raw sensor to be enabled properly, the corresponding
  ...
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_RMGSEN, RAW_SENSITIVITY_MIN)))  // Set Raw Acc (and corresponding sensor (Cmp)) sensitivity to "0" to
                                         //achieve the desired data rate for raw sensors (see spec).
    error_handler("VRWr", VREG_RMGSEN, (s->ucRetStat));    // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_CMSEN, RAW_SENSITIVITY_MIN))) // Set Cmp sensitivity to "0" to achieve the desired data rates for raw sensors.
    error_handler("VRWr", VREG_CMSEN, (s->ucRetStat));    // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_RMGDR, RAW_DATA_RATE)))  // Change data rate
    error_handler("VRWr", VREG_RMGDR, (s->ucRetStat));     // error display

  (s -> dMult) = ret_exponent(RAW_MAG_VREG_OFFSET);          // Get unit exponent for this sensor's data
}

void readRawMagnet(sensor *s) {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_RMGXD, &(s -> wdata))))  // Read data from the raw magnometer datax register
      error_handler("VRRd", VREG_RMGXD, (s->ucRetStat)); // error display

    (s -> dDataX) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_RMGYD, &(s -> wdata))))  // Read data from the raw magnometer datay register
      error_handler("VRRd", VREG_RMGYD, (s->ucRetStat)); // error display

    (s -> dDataY) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_RMGZD, &(s -> wdata))))  // Read data from the raw magnometer dataz register
      error_handler("VRRd", VREG_RMGZD, (s->ucRetStat)); // error display

    (s -> dDataZ) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value
}

void finishRawMagnet(sensor *s) {
  //Disable the Raw Magnometer on exit
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
  {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) & ~(VREG_SHC_RAWMAG_EN | VREG_SHC_CMP_EN)))) // Disable the Raw Magnometer (clear the RAWMAG_EN bit) & corresponding CMP_EN
      error_handler("VRWr", VREG_SHC, (s->ucRetStat));      // error display
  }
  else
    error_handler("VRRd", VREG_SHC, (s->ucRetStat)); // error display
...
void initRawGyro(sensor *s) {
  // Enable the Raw Gyrometer
  // To support multi-threaded applications, Read-Modify-Write the VREG:
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s -> wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
  {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) | VREG_SHC_RAWGYR_EN | VREG_SHC_GYRO_EN))) // Enable the Raw Gyrometer (GYR_EN) & corresponding GYRO sensor
                                                        //rev 0.10 spec: 'for any raw sensor to be enabled properly, the corresponding
  ...
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_RGYSEN, RAW_SENSITIVITY_MIN))) // Set Raw Gyro (and corresponding sensor (Gyro)) sensitivity to "0" to
                                        //achieve the desired data rate for raw sensors (see spec).
    error_handler("VRWr", VREG_RACSEN, (s->ucRetStat));    // error display

  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_GYSEN, RAW_SENSITIVITY_MIN))) // Set Gyro sensitivity to "0" to achieve the desired data rates for raw sensors.
    error_handler("VRWr", VREG_GYSEN, (s->ucRetStat));    // error display


  if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_RGYDR, RAW_DATA_RATE)))  // Change data rate
    error_handler("VRRd", VREG_RGYDR, (s->ucRetStat));     // error display

  (s -> dMult) = ret_exponent(RAW_GYR_VREG_OFFSET);          // Get unit exponent for this sensor's data
}

void readRawGyro(sensor *s) {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_RGYXD, &(s -> wdata)))) // Read data from the raw gyrometer datax register
      error_handler("VRRd", VREG_RGYXD, (s->ucRetStat)); // error display

    (s -> dDataX) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_RGYYD, &(s -> wdata)))) // Read data from the raw gyrometer datay register
      error_handler("VRRd", VREG_RGYYD, (s->ucRetStat)); // error display

    (s -> dDataY) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value

    if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_RGYZD, &(s -> wdata)))) // Read data from the raw gyrometer dataz register
      error_handler("VRRd", VREG_RGYZD, (s->ucRetStat)); // error display

    (s -> dDataZ) = (int16_t)(s -> wdata) * (s -> dMult);                    // Multiply this by the exponent scaler to get floating point value
}

void finishRawGyro(sensor *s) {
  //Disable the Raw Gyro on exit
  if (((s->ucRetStat) = HOST_SF_LIB_VREG_read(VREG_SHC, &(s->wRMWdata))) == SUCCESS)  // Read data from the Sensor Hub Configuration register
  {
    if (((s->ucRetStat) = HOST_SF_LIB_VREG_write(VREG_SHC, (s -> wRMWdata) & ~(VREG_SHC_RAWGYR_EN | VREG_SHC_GYRO_EN)))) // Disable the raw gyro (clear the GYR_EN bit) & corresponding GYRO_EN
      error_handler("VRWr", VREG_SHC, (s->ucRetStat));      //error display
  }
  else
    error_handler("VRRd", VREG_SHC, (s->ucRetStat)); // error display

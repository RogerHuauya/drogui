...
void getKalmanGain(){
    ...
    //serialWriteString( "Get Kalman Gain\n");
...
void UpdatePmCovGPS(){
    //serialWriteString( "Update Pm Cov GPS\n");
    mat aux1,aux2;
    matInit(&aux1, 9, 9);
    matInit(&aux2, 9, 9);
    ////serialWriteString( "Matriz \n");
    ////printMat(&aux1);
    ////serialWriteString( "KG \n");
    ////printMat(&KalmanGain);
    ////serialWriteString( "Hm \n");
    ////printMat(&Hm);
    matMult(&aux1, &KalmanGain, &Hm);
    ////serialWriteString( "aux1 \n");
    ////printMat(&aux1);
...
void kalmanUpdate(){
    ...
    if (cont>100){
        ...
        getBias();
        ////serialWriteString( "hola1\n");
        
        UpdatePmCovGPS();
        //serialWriteString( "hola2\n");
